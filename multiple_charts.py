...
layout = html.Div ([
            ...
            html.Div([
                ...
                html.Div([
                    dcc.Dropdown(
                        ...
                        ], style={'background-color':'white','padding-right': '1cm','color':'rgb(217, 224, 236)','float':'left','width': '22%'}),
    ...
    html.Div(id='filtered-content', style={'clear':'both'}),
