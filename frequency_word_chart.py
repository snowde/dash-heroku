...
def four_figs():
    ...
    g_b = pd.read_csv(first + "_" + second + ".csv")

    b_g = pd.read_csv(second + "_" + first + ".csv")

    g_b_p = pd.read_csv(first + "_" + second + "_pro.csv")

    b_g_p = pd.read_csv(second + "_" + first + "_pro.csv")
